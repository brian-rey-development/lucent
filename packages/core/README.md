...
The engine. It takes the text of a `.lucent.md` file and a function that reads files relative to it, and returns a
report: diagnostics plus the estimated timeline. It performs no I/O of its own.
