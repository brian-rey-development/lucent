...
- 43 diagnostic codes. Each has a test in which one mistake produces exactly that one diagnostic, at an exact line and
...
- The catalog of 18 verbs measures about 480 tokens against a threshold of 1,111.
