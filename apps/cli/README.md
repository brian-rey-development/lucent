...
`{ file, ok, errors, warnings, diagnostics, omitted, timeline }`, where `omitted` counts diagnostics beyond the first
50. Usage and read errors print `{ ok: false, error }` instead.
